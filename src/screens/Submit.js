...
class Submit extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      endTime: moment().add(2, 'weeks').format("YYYY-MM-DD HH:mm"),
      ready: true,
      divisionId: ''
    };
  ...
  async submit(divisionId) {
    var url = 'https://flyerentapi.herokuapp.com/promotion/create';
    //var url = 'http://localhost:3000/promotion/create';
