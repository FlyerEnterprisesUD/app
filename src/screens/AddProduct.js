...
class AddProduct extends Component {
  ...
  async submit() {
    var url = 'https://flyerentapi.herokuapp.com/menu/createproduct';
    //var url = 'http://localhost:3000/menu/createproduct';
  ...
  render() {
    ...
    return(
      ...
      <ScrollView style={ styles.container }>
        ...
        <View>
          <Text style={{marginTop: 20, marginLeft: 16, color: '#515151', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16 }}>Product</Text>
          ...
          <View style={{marginTop: 10, marginBottom: 120}}>
            <TouchableOpacity onPress={this.submit}>
              <View style={styles.button}>
                <Text style={{color: '#FFFFFF', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16}}>Add Product</Text>
              </View>
            </TouchableOpacity>
          </View>
