...
class AddIngredient extends Component {
  ...
  async submit() {
    var url = 'https://flyerentapi.herokuapp.com/menu/addingredient';
  ...
  render() {
    ...
    return(
      ...
      <ScrollView style={ styles.container }>
        ...
        <View>
          <Text style={{marginTop: 20, marginLeft: 16, color: '#515151', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16 }}>{this.props.product.name}</Text>
          ...
          <View style={{marginTop: 10, marginBottom: 120}}>
            <TouchableOpacity onPress={this.submit}>
              <View style={styles.button}>
                <Text style={{color: '#FFFFFF', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16}}>Add Ingredient</Text>
              </View>
            </TouchableOpacity>
          </View>
