...
class EditIngredient extends Component {
  ...
  componentWillMount() {
    this.setState({name: this.props.ingredient.name});
  }

  async submit() {
    var url = 'https://flyerentapi.herokuapp.com/menu/updateingredient';
  ...
  async delete() {
    var url = 'https://flyerentapi.herokuapp.com/menu/deleteingredient';
  ...
  render() {
    ...
    return(
      ...
      <ScrollView style={ styles.container }>
        ...
        <View>
          <Text style={{marginTop: 10, marginLeft: 16, color: '#515151', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16 }}>{this.props.ingredient.name}</Text>
          ...
          <View style={{marginTop: 10}}>
            <TouchableOpacity onPress={this.submit}>
              <View style={styles.button}>
                <Text style={{color: '#FFFFFF', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16}}>Update Ingredient</Text>
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style={{marginTop: 10, marginBottom: 120}}>
            <TouchableOpacity onPress={this.delete}>
              <View style={styles.button}>
                <Text style={{color: '#FFFFFF', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16}}>Delete Ingredient</Text>
              </View>
            </TouchableOpacity>
          </View>
