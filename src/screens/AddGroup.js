...
class AddGroup extends Component {
  ...
  async submit() {
    var url = 'https://flyerentapi.herokuapp.com/menu/creategroup';
  ...
  render() {
    ...
    return(
      ...
      <ScrollView style={ styles.container }>
        ...
        <View>
          <Text style={{marginTop: 20, marginLeft: 16, color: '#515151', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16 }}>Group</Text>
          ...
          <View style={{marginTop: 10, marginBottom: 120}}>
            <TouchableOpacity onPress={this.submit}>
              <View style={styles.button}>
                <Text style={{color: '#FFFFFF', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16}}>Add Group</Text>
              </View>
            </TouchableOpacity>
          </View>
