...
class EditGroup extends Component {
  ...
  async submit() {
    var url = 'https://flyerentapi.herokuapp.com/menu/updategroup';
  ...
  async delete() {
    var url = 'https://flyerentapi.herokuapp.com/menu/deletegroup';
    //var url = 'http://localhost:3000/menu/updategroup';
  ...
  render() {
    ...
    return(
      ...
      <ScrollView style={ styles.container }>
        ...
        <View>
          <Text style={{marginTop: 10, marginLeft: 16, color: '#515151', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16 }}>Group</Text>
          ...
          <View style={{marginTop: 10}}>
            <TouchableOpacity onPress={this.submit}>
              <View style={styles.button}>
                <Text style={{color: '#FFFFFF', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16}}>Update Group</Text>
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style={{marginTop: 10, marginBottom: 120}}>
            <TouchableOpacity onPress={this.delete}>
              <View style={styles.button}>
                <Text style={{color: '#FFFFFF', fontFamily: 'avenir' , fontWeight: 'bold', fontSize: 16}}>Delete Group</Text>
              </View>
            </TouchableOpacity>
          </View>
