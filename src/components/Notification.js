...
class Notification extends Component {
  ...
  navigateToEditSubmit(notification) {
    this.props.navigator.push({id: 'EditSubmit Push', user: this.props.user, token: this.props.token, notification: notification});
  }
  ...
  render() {
    return (
      ...
      {
        this.props.division.notifications.map((l, i) => (
